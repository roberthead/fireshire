      ...
      <header className="app-header">
        <div className="app-header__inner">
          <h1 className="app-header__wordmark">
            <Link to="/" search={{ address: '' }} className="app-header__link">
              <span className="app-header__fire">Fire</span>
              <span className="app-header__shire">Shire</span>
            </Link>
          </h1>
          <nav className="app-nav">
            <Link to="/" search={{ address: '' }} className="app-nav__link" activeProps={{ className: 'app-nav__link app-nav__link--active' }}>
              Map
            </Link>
